...
Le papier derive des scores centiles d'asymetrie individualises (GAMLSS) et les propose comme marqueur potentiel transdiagnostique. Il rapporte des differences cas-temoins significatives (P_FDR<0.05) et une variabilite accrue des scores chez les patients autisme, schizophrenie et Alzheimer, mais sans discrimination au niveau individuel ni validation (pas d'AUC ni de classifieur). Les auteurs presentent l'usage clinique comme une perspective future.

> « we observed far more extreme centile scores in cases compared to controls, quantified as a greater standard deviation in centile scores in individuals with neurodevelopmental and neurodegenerative disorders »
