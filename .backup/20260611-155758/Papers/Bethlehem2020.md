...
Modélisation normative de l'épaisseur corticale liée à l'âge produisant des cartes de w-scores individualisées chez les hommes autistes. Les déviations sont hétérogènes : les tests sur les cartes normatives ne révèlent aucune région survivant à la correction FDR, et les faibles différences cas-témoins (27/308 régions) sont surtout portées par un petit sous-groupe d'outliers. Approche personnalisée proposée pour prioriser un sous-groupe, mais sans discrimination validée : preuve préliminaire.

> « Over all brain regions the median prevalence of these patients is around 7.6% ... This difference from an expected proportion of 5% in the present sample corresponds to a X2 of 3.85 ... significant at p = 0.049. »
