...
## Papiers
- [[Chen2021]] — Revoit la connectivité fonctionnelle et le gradient principal, en soulignant la faible fiabilité de la fMRI de tâche.
- [[DeBoer2024]] — Second jeu de test : représentation latente dérivée d'IRMf (autoencodeur + UMAP).
...
- [[Lawn2024]] — Connectivité fonctionnelle d'IRMf de repos enrichie par templates moléculaires PET/SPECT (REACT).
- [[Lin2024]] — Connectivité fonctionnelle statique et dynamique (IRMf de repos).
- [[Marquand2016]] — Les features sont des contrastes fMRI récompense–baseline issus d'une tâche de gambling.
- [[Marquand2019]] — Exemples portant sur l'activité cérébrale fonctionnelle (ex. systèmes de récompense).
- [[OliveiraSaraiva2023]] — Travaille sur la connectivité fonctionnelle issue de rs-fMRI au repos.
- [[Xie2025]] — Métriques dérivées du rs-fMRI : variabilité du signal, homogénéité régionale, force de nœud.
