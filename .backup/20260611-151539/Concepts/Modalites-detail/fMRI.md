...
## Papiers
- [[Chen2021]] — Modalité fonctionnelle revue, dont la faible fiabilité test-retest est identifiée comme un frein aux biomarqueurs.
- [[DeBoer2024]] — Représentation latente hautement non-linéaire dérivée d'IRMf (jeu de Zabihi et al., n=20 781).
...
- [[Lawn2024]] — IRM fonctionnelle de repos, base des cartes de connectivité enrichies par REACT.
- [[Lin2024]] — Connectivité fonctionnelle de repos (statique aFCS, dynamique fFCS).
- [[Marquand2016]] — IRM fonctionnelle de tâche (incentive processing) fournissant les variables réponses.
- [[Marquand2019]] — Modalité fonctionnelle illustrant le mapping vers l'activité cérébrale.
- [[OliveiraSaraiva2023]] — Données rs-fMRI au repos prétraitées sous FSL (MELODIC, ICA, dual regression).
- [[Xie2025]] — IRM fonctionnelle de repos (rs-fMRI) servant à calculer les trois métriques d'activité intrinsèque.
