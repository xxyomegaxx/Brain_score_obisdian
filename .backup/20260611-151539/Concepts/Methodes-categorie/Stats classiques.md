...
## Papiers
- [[Alyas2025]] — Couvre des méthodes statistiques : régression linéaire, GPR, GAMLSS, HBR.
...
- [[Ge2024]] — Compare exclusivement des méthodes statistiques (régression linéaire/bayésienne, GAMLSS, polynômes fractionnaires), sans apprentissage profond.
...
- [[Lin2024]] — Modèle normatif d'âge sexe-spécifique (statistique), sans apprentissage profond.
...
- [[Rutherford2022b]] — Repose sur des régressions bayésiennes/statistiques (BLR, Warped BLR, HBR, GPR), pas d'apprentissage profond.
- [[Shao2024]] — Régression linéaire bayésienne (BLR), sans apprentissage profond.
- [[Verdi2024]] — Repose sur une régression bayésienne non-gaussienne (cadre braincharts) avec transfert par site, sans apprentissage profond.
- [[Wolfers2018]] — Modèle normatif estimé par régression par processus gaussien (statistique, non profond).
- [[Wolfers2020]] — Repose sur la régression par processus gaussien, méthode bayésienne non-paramétrique, sans apprentissage profond.
- [[Xie2025]] — Modèle normatif par régression linéaire (âge, sexe) puis apprentissage supervisé classique sur les déviations.
- [[Zabihi2019]] — Utilise la régression par processus gaussien, un modèle statistique bayésien non profond.
