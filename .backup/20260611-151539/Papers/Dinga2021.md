...
Article purement methodologique : introduction du cadre GAMLSS pour la modelisation normative neuro-imagerie, outils de diagnostic/validation des modeles, et exemples didactiques pas-a-pas (effets d'age, sexe, site sur l'epaisseur corticale UK Biobank). Aucune population clinique n'est discriminee et aucun claim de biomarqueur n'est realise dans ce papier ; les comparaisons portent sur l'ajustement des modeles (log-score, W de Shapiro-Wilk).

> « The contribution of this paper is threefold; 1) we introduce GAMLSS for normative modeling of the brain. 2) We describe ways to evaluate normative models and their potential pitfalls ... 3) We show step-by-step didactic examples »
